  ...
  return (
    <section id="contact" className="bg-paper py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-4 rounded-2xl border border-fg/10 bg-surface p-8 shadow-sm">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="name" className="text-sm font-medium text-fg/70">
                Name
              </label>
              <input
                id="name"
                ...
                className="mt-1.5 w-full rounded-lg border border-fg/15 px-4 py-2.5 text-fg outline-none focus:border-spark"
              />
            </div>
            <div>
              <label htmlFor="email" className="text-sm font-medium text-fg/70">
                Email
              </label>
              <input
                id="email"
          ...
          <div>
            <label htmlFor="message" className="text-sm font-medium text-fg/70">
              Message
            </label>
            <textarea
              id="message"
